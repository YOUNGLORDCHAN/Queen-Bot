...
const SUDO = process.env.SUDO || '254104245659';
...
const BOT_INFO = process.env.BOT_INFO || "Queen-BOT-MD; Giddy Tennor;https://i.imgur.com/r3GZeiX.jpeg";
const URL = process.env.URL || "https://www.instagram.com/giddy_tennor_?igsh=YzZ0NDRoaXFxM2Zk";
const AUDIO_DATA = process.env.AUDIO_DATA || "Queen BOT MD; Giddy Tennor;https://i.imgur.com/fVCRCYG.jpeg";
